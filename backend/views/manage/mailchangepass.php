            ...
            <div class="span4 box">
                <div class="content-wrap">
                    ...
                    echo $form->field($model, 'adminuser')
                            ->hiddenInput(["class" => "span12"]);
                    echo $form->field($model, 'adminpass')
                            ->passwordInput(["class" => "span12", "placeholder" => "新密码"]);
                    echo $form->field($model, 'repass')
                            ->passwordInput(["class" => "span12", "placeholder" => "确认密码"]);
                    ?>
                    <!--忘记密码-->
                    ...
                    <?php
                    //登录按钮
                    echo Html::submitButton('确认修改', ["class" => "btn-glow primary login"])
                    ?>
                    <?php ActiveForm::end(); ?>
                </div>
            </div>
